...
public class MyFirstPluginOverlay extends OverlayPanel {
    ...
    @Inject
    MyFirstPluginOverlay(MyFirstPlugin plugin) {
        super(plugin);
        setPosition(OverlayPosition.TOP_LEFT);
        setNaughty();
        myButton = new ButtonComponent("My Plugin");
        ...
        myButton.setOnClick(() -> Microbot.openPopUp("Microbot", String.format("S-1D:<br><br><col=ffffff>%s Popup</col>", "My First Plugin")));
    }
